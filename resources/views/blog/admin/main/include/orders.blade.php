...
<div class="box box-info">
        ...
        <div class="table-responsive">
            <table class="table no-margin">
                ...
                @foreach($last_orders as $order)
                    <tr>
                        <td><a href="{{route('blog.admin.order.edit', $order->id)}}">{{$order->id}}</a></td>
    ...
    <div class="box-footer clearfix">
        <a href="{{route('blog.admin.order.index')}}" class="btn btn-sm btn-info btn-flat pull-left">Все заказы</a>
    </div>
    <!-- /.box-footer -->
</div>
<!-- /.box -->
